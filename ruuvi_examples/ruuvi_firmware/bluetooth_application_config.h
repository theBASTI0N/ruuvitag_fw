...
#define APPLICATION_DEVICE_NAME         "RuuviDoor"                     /**< BLE name displayed in scan response. */
#define APPLICATION_DEVICE_NAME_LENGTH  9                               /**< number of characters in above string, excluding null */
